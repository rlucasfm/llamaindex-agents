...
## Instagram search
def instagram_search(query: str):
    duckduckgo_spec = DuckDuckGoSearchToolSpec()
    return duckduckgo_spec.duckduckgo_full_search(f"site:instagram.com {query}")

instagram_search_tool = FunctionTool.from_defaults(
    fn=internet_search,
    name="Internet_search",
    description="this tool makes a search on the internet for any topic"
)